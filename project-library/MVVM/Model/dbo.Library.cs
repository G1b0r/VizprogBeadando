...
// Code is generated on: 2025. 04. 25. 13:36:08
//
...
namespace Library
{
    ...
    public partial class LibraryDbContext : DbContext
    {
        ...
        private void BooksMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Books>().Property(x => x.book_id).HasColumnName(@"book_id").IsRequired().ValueGeneratedNever();
        ...
        private void TransactionsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Transactions>().Property(x => x.transaction_id).HasColumnName(@"transaction_id").IsRequired().ValueGeneratedNever();
        ...
        private void MembersMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Members>().Property(x => x.member_id).HasColumnName(@"member_id").IsRequired().ValueGeneratedNever();
